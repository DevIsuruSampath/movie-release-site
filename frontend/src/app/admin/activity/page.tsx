  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-1 text-sm text-gray-400">Recent admin activity and audit trail.</p>
      </div>

      <div className="space-y-3">
        {data.items.map((item) => (
          <div key={item.id} className="rounded-2xl border border-white/10 bg-white/[0.03] px-5 py-4">
