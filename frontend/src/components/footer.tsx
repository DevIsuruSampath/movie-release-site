        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div className="space-y-4">
            <Link href="/" className="flex items-center gap-2 group">
              <div className="relative w-10 h-10 flex items-center justify-center bg-[#e50914] rounded-lg group-hover:scale-110 transition-transform">
            ...
            <div className="flex gap-4">
              {footerLinks.Connect.map((link) => (
                <a
                  key={link.href}
                  href={link.href}
                  className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center text-gray-400 hover:bg-[#e50914] hover:text-white transition-all hover:scale-110"
