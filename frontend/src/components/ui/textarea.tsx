    ...
    return (
      <div className="space-y-2.5">
        ...
        <textarea
          ...
          className={cn(
            'min-h-[140px] w-full rounded-2xl border border-white/10 bg-[#11151d] px-4 py-3 text-sm text-white shadow-[inset_0_1px_0_rgba(255,255,255,0.04)] transition-all placeholder:text-slate-500 focus:border-[#ff676f]/70 focus:outline-none focus:ring-4 focus:ring-[#e50914]/15',
